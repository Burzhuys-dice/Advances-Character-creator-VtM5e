const stepGuides = {
    1: {
        ...
        text: "Цей крок визначає базову ідентичність вашого вампіра, його походження та місце у суспільстві нічних хижаків. Сформулюйте короткий концепт, впишіть ім'я, оберіть клан (що визначає ваш Клановий примус та Прокляття) та опишіть історію."
    },
    2: {
